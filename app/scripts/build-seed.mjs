 ...
 *
 * Usage: node app/scripts/build-seed.mjs
 */
...
Generated by \`app/scripts/build-seed.mjs\` from **Job_list_10th_Sept_3.docx**.

- Source lines: **${lines.length}**
- Jobs created: **${jobs.length}**
- Work items created: **${itemCount}**
- Rows flagged: **${new Set(flags.map(f => f.idx)).size}** of ${itemCount}
...
console.log(`jobs=${jobs.length} work_items=${itemCount} flags=${flags.length} flagged_rows=${new Set(flags.map(f => f.idx)).size}`);
